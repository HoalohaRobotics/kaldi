...
int LatticeAlignWords(int argc, char* argv[]) {
    try {
        ...
        std::string word_boundary_rxfilename = "exp/chain_cleaned/tdnn_1d_sp/graph_tgsmall/phones/word_boundary.int";
        std::string model_rxfilename = "exp/chain_cleaned/tdnn_1d_sp/final.mdl";
        std::string lats_rspecifier = "ark:data/convert_me/out/lattice1best.ark";
        std::string lats_wspecifier = "ark:data/convert_me/out/word_align_lattice.ark";
